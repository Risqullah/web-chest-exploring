...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['register'])) {
    ...
    $check = $koneksi->prepare("SELECT * FROM user WHERE username = ?");
...
<head>
    ...
    <style>
        body {
            background: url('https://i.pinimg.com/originals/48/4b/32/484b325cdb5bdd8bce6d8e3d131fda75.gif') no-repeat center center fixed;
